							...
							<div class="reply_write_li">
								<sec:authorize access="isAuthenticated()">
									<div class="reply_thumb_box">
										<div class="thumb"
											style="background: url(http://drive.google.com/uc?export=view&id=<sec:authentication property="principal.member.photo"/>)no-repeat top center; background-size:cover; background-position: center">
										</div>
									</div>
